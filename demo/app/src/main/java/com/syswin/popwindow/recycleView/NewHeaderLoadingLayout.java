...
public class NewHeaderLoadingLayout extends LoadingLayout {
    ...
    public NewHeaderLoadingLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void startMove(int scrollY) {
        if (this.animators != null && this.animators.size() > 0) {
            Iterator var2 = this.animators.iterator();

            while (var2.hasNext()) {
                ValueAnimator animation = (ValueAnimator) var2.next();
                animation.cancel();
            }
        }
    ...
    public void setMoveView1(int top) {
        ...
        if (top >= start_y && top <= end_y) {
            ...
            this.ivLoading1.setTranslationY((float) (top - start_y + 1));
    ...
    public void setMoveView2(int top) {
        ...
        if (top >= start_y && top <= ll_h) {
            ...
            this.ivLoading2.setTranslationY((float) (top - start_y));
    ...
    public void setMoveView3(int top) {
        ...
        if (top >= ll_h && top <= end_y) {
            ...
            this.ivLoading3.setTranslationY((float) (top - ll_h));
    ...
    public void setMoveView(boolean isLoading) {
        if (isLoading) {
            this.ivLoading1.setVisibility(View.VISIBLE);
            this.ivLoading2.setVisibility(View.VISIBLE);
            this.ivLoading3.setVisibility(View.VISIBLE);
